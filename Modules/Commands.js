    ...
    if (command != undefined) {
        ...
        if (!toFile) {
            ...
            if (commandName === "cls" || commandName === "clearscreen" || commandName === "clear") {
                refreshPage();
            } else if ((commandName === "exit")|| (commandName === "quit")|| (commandName === "terminate")){
                ...
                BibleDanish(data);
            } else if (commandName.includes("bible:french:")) {
                const data = commandName.trim().replace(/^bible:french:\b\s*/i, '');
                BibleFrench(data);
