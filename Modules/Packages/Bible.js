...
function BibleSwedish(input) {
    ...
    if (bookIndex !== -1) {
        const bookNumber = bookIndex + 1;
        const parser = new DOMParser();
        const xmlDoc = parser.parseFromString(bible_swedish, 'text/xml');
        const verses = [];
...
function BibleGerman(input) {
    ...
    if (bookIndex !== -1) {
        const bookNumber = bookIndex + 1;
        const parser = new DOMParser();
        const xmlDoc = parser.parseFromString(bible_german, 'text/xml');
        const verses = [];
...
function BibleFinnish(input) {
    ...
    if (bookIndex !== -1) {
        const bookNumber = bookIndex + 1;
        const parser = new DOMParser();
        const xmlDoc = parser.parseFromString(bible_finnish, 'text/xml');
        const verses = [];
...
function BibleFrench(input) {
    ...
    if (bookIndex !== -1) {
        const bookNumber = bookIndex + 1;
        const parser = new DOMParser();
        const xmlDoc = parser.parseFromString(bible_french, 'text/xml');
        const verses = [];
